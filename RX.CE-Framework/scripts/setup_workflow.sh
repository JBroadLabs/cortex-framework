...
echo "=== Setting up RX.CE-Framework Workflow State Machine ==="
echo ""
...
echo ""
echo "Quick start:"
echo "  python3 RX.CE-Framework/scripts/workflow_engine.py status   # View story status"
echo "  python3 RX.CE-Framework/scripts/workflow_engine.py next     # See next actions"
echo "  python3 RX.CE-Framework/scripts/workflow_engine.py pending  # Check pending delegations"
echo ""
