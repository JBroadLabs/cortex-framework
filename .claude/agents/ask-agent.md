---
name: ask-agent
description: Framework expert for questions, troubleshooting, and guidance. Read-only advisory role with no state changes.
...
- **Knowledge**:
  ...
  - `docs/CONTEXT_LEARNING.md` - Context learning system
